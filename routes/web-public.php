...
// Public careers route (no auth middleware)
Route::get('/careers/{jobOffer}', [HomeController::class, 'publicShow'])->name('public.job-offers.show');
// Routes publiques pour les candidatures
Route::get('/careers/all/{companyId}', [HomeController::class, 'publicIndex'])->name('public.job-offers.index');
Route::get('/careers/form/{jobOffer}/showApplyForm', [HomeController::class, 'showApplyForm'])->name('public.job-offers.apply-form');
Route::post('/careers/{jobOffer}/apply', [HomeController::class, 'apply'])->name('public.job-offers.apply');
