    ...
    <div class="px-4 py-2 border-top-0 emp-dashboard">
        ...
        <div class="d-lg-flex d-md-flex d-block py-2 pb-2 align-items-center">
            ...
            <div class="ml-auto d-flex clock-in-out mb-3 mb-lg-0 mb-md-0 m mt-4 mt-lg-0 mt-md-0 justify-content-end">
                <!-- mb-0 text-lg-right text-md-right f-18 font-weight-bold text-dark-grey d-grid align-items-center -->
                <p
                    class="tw-flex tw-justify-center tw-items-center tw-text-[#404040] tw-mb-0 tw-text-lg-right tw-text-md-right tw-text-[18px] tw-font-bold tw-text-dark-grey tw-grid tw-items-center">
                ...
                @if (in_array('attendance', user_modules()))
                    @if ((is_null($currentClockIn) && $checkJoiningDate == true) || (is_null($currentClockIn) && $flagbtn == false))
                        <div>
                            <button type="button" class="tw-bg-black tw-text-white tw-rounded tw-px-2 tw-py-2 tw-mx-4"
                                id="clock-in"
                                ...
                                data-toggle="tooltip" data-placement="top" title="{{ __($msg) }}" @endif><i
                                    class="icons icon-login mr-2 tw-text-white "></i>@lang('modules.attendance.clock_in')</button>
                        </div>
                    @endif
                @endif
                ...
                @if (
                    ...
                    <div>
                        <button type="button" class="tw-bg-black tw-text-white tw-rounded tw-px-2 tw-py-2 tw-mx-4" id="clock-out"><i
                                class="icons icon-login mr-2 tw-text-white"></i>@lang('modules.attendance.clock_out')</button>
                    </div>
                @endif
                                    ...
                                    <div class="p-4">
                                        <div class="d-flex flex-wrap justify-content-between">
                                            @if (in_array('tasks', user_modules()))
                                                <span>
                                                    <label class="f-12 text-dark-grey tw-mb-0" for="usr">
                                            ...
                                            @if (isset($totalOpenTickets) && in_array('tickets', user_modules()))
                                                <span>
                                                    <label class="f-12 text-dark-grey tw-mb-0 tw-mb-0" for="usr">
                    ...
                    @if (in_array('tasks', $activeWidgets) &&
                        ...
                        <div class="col-md-6 mb-3">
                            <div
                                ...
                                <div class="d-block ">
                                    <h5 class="f-15 f-w-500  text-darkest-grey">@lang('app.menu.tasks')</h5>
                                    <div class="d-flex">
                                        <a href="{{ route('tasks.index') . '?assignee=me' }}">
                                        ...
                                        <a href="{{ route('tasks.index') . '?assignee=me&overdue=yes' }}">
                                            <p class="mb-0 f-21 font-weight-bold text-red d-grid">
                                                {{ $dueTasks }}
                                                <span class="f-12 font-weight-normal text-lightest">@lang('app.overdue')</span>
                                            </p>
                                        </a>
                                    </div>
                                </div>
