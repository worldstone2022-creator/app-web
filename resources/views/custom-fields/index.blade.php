                                    ...
                                    <tr class="row{{ $field->id }}">
                                        ...
                                        <td>
                                            <div class="task_view-quentin">
                                                <a data-user-id="{{ $field->id }}" class="task_view-quentin_more quentin tw-border-none tw-bg-[#838383] tw-text-start tw-p-2 tw-text-white tw-rounded-md quentin edit-custom-field" href="javascript:;">
                                                    <i class="fa fa-edit icons mr-2"></i> {{ __('app.edit') }}
                                                </a>
                                            </div>
                                            <div class="task_view-quentin">
                                                <a data-user-id="{{ $field->id }}" data-module="{{ $module }}" class="task_view-quentin_more quentin tw-border-none tw-bg-[#838383] tw-text-start tw-p-2 tw-text-white tw-rounded-md quentin sa-params" href="javascript:;">
