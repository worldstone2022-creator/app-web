    ...
    <form id="login-form" action="{{ route('login') }}" class="ajax-form" method="POST">
        ...
        @if ($socialAuthSettings->social_auth_enable_count>1 && !$errors->has('g-recaptcha-response'))
            <button type="submit" id="submit-next"
                    class="tw-bg-orange-400 hover:tw-bg-orange-500 tw-text-white tw-w-full tw-px-6 tw-flex tw-items-center tw-justify-center tw-py-2 tw-rounded-lg tw-font-medium tw-transition tw-duration-200 "> @lang('auth.next') <i
