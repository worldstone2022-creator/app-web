...
<x-auth>
    ...
    <form id="two-factor-challenge-form"
        ...
        <button type="submit" id="submit-login"
                class="btn tw-bg-orange-400 hover:tw-bg-orange-500 tw-text-white tw-w-full tw-px-6 tw-flex tw-items-center tw-justify-center tw-py-2 tw-rounded-lg tw-font-medium tw-transition tw-duration-200  otp-submit">
