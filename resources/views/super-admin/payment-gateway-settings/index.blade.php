...
@push('scripts')
    ...
    <li class="-more bg-grey">
        <button type="button" class="px-4 h-100 w-100 d-lg-flex d-mquentin tw-border-none tw-bg-[#838383] tw-text-start tw-p-2 tw-text-white tw-rounded-md quentin py-3" aria-haspopup="true" aria-expanded="false">
        More <span>&darr;</span>
        </button>
