...
return [
  ...
  'match' => [
    'title' => 'თქვენ კი შეგიძლიათ მიჰყვეთ ქვემოთ მოცემულ შაბლონს',
    'pattern' => '<p>1. <b>ტესტი</b> (ზუსტი დამთხვევა)</p>
                            <p>2. <b>%test%</b> (შეესაბამება სტრიქონში ნებისმიერ ადგილას)</p>
                            <p>3. <b>%ტესტი</b> (ემთხვევა სადმე, მაგრამ უნდა დასრულდეს „ტესტით“)</p>',
  ],
];