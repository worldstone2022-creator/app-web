...
return [
  ...
  'match' => [
    'title' => 'Bạn thậm chí có thể làm theo mẫu dưới đây',
    'pattern' => '<p>1. <b>kiểm tra</b> (kết quả khớp chính xác)</p>
                            <p>2. <b>%test%</b> (khớp với bất kỳ vị trí nào trong chuỗi)</p>
                            <p>3. <b>%test</b> (khớp ở mọi nơi nhưng phải kết thúc bằng \'test\')</p>',
  ],
];