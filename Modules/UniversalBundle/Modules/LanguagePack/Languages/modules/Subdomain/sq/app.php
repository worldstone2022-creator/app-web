...
return [
  ...
  'match' => [
    'title' => 'Mund të ndiqni edhe modelin e mëposhtëm',
    'pattern' => '<p>1. <b>test</b> (përputhja e saktë)</p>
                            <p>2. <b>%test%</b> (përputhet kudo në varg)</p>
                            <p>3. <b>%test</b> (përputhet kudo, por duhet të përfundojë me \'test\')</p>',
  ],
];