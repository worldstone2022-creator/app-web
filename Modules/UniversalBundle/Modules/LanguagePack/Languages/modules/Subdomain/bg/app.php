...
return [
  ...
  'match' => [
    'title' => 'Можете дори да следвате модела по-долу',
    'pattern' => '<p>1. <b>тест</b> (точно съвпадение)</p>
                            <p>2. <b>%test%</b> (съвпада навсякъде в низа)</p>
                            <p>3. <b>%test</b> (съвпада навсякъде, но трябва да завършва с \'test\')</p>',
  ],
];