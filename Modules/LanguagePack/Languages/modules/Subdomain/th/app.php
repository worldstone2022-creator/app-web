...
return [
  ...
  'match' => [
    'title' => 'คุณสามารถทำตามรูปแบบด้านล่างได้',
    'pattern' => '<p>1. <b>ทดสอบ</b> (ตรงทั้งหมด)</p>
                            <p>2. <b>%test%</b> (จับคู่ที่ใดก็ได้ในสตริง)</p>
                            <p>3. <b>%test</b> (จับคู่ได้ทุกที่แต่ต้องลงท้ายด้วย \'test\')</p>',
  ],
];