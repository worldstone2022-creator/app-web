...
return [
  ...
  'match' => [
    'title' => 'Можете чак пратити образац испод',
    'pattern' => '<п>1. <б>тест</б> (потпуно подударање)</п>
                            <п>2. <б>%тест%</б> (подударање било где у низу)</п>
                            <п>3. <б>%тест</б> (подударање било где, али мора да се завршава са \'тест\')</п>',
  ],
];