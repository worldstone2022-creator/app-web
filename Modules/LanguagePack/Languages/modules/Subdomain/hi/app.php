...
return [
  ...
  'match' => [
    'title' => 'आप नीचे दिए गए पैटर्न का भी पालन कर सकते हैं',
    'pattern' => '<p>1. <b>परीक्षण</b> (सटीक मिलान)</p>
                            <p>2. <b>%test%</b> (स्ट्रिंग में कहीं भी मिलान करें)</p>
                            <p>3. <b>%test</b> (कहीं भी मेल करें लेकिन \'परीक्षण\' के साथ समाप्त होना चाहिए)</p>',
  ],
];